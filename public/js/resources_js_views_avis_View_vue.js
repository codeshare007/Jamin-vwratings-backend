...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  filters: {
    ...
    date: function date(data) {
      return moment__WEBPACK_IMPORTED_MODULE_1___default()(data).format('MMMM Do YYYY, h:mm:ss');
    }
  },
  ...
  computed: {
    ...
    sortedComments: function sortedComments() {
      ...
      if (this.pics) {
        return this.avi.comments.filter(function (item) {
          if (item['attachments'].length) return item;
        });
      } else {
        return this.avi.comments.sort(function (a, b) {
          var modifier = 1;
          if (_this.sortDir === 'desc') modifier = -1;
          if (a[_this.sort] < b[_this.sort]) return -1 * modifier;
          if (a[_this.sort] > b[_this.sort]) return 1 * modifier;
          return 0;
        });
      }
  ...
  methods: {
    sortComments: function sortComments(sort, sortDir) {
      this.pics = false;
    ...
    comment: function comment(e) {
      ...
      if (this.$refs.file.files.length) {
        for (var i = 0; i < this.$refs.file.files.length; i++) {
          ...
          formData.append("attachments[".concat(i, "]"), file);
        }
      }

      this.$api.avis.comment(this.id, formData).then(function () {
        _this4.form = {
          comment: null,
          reaction: null
        };
        ...
        ? _c(
            ...
            [
              _c("div", { staticClass: "text-center" }, [
                ...
                _vm._v(" "),
                _c("p", [
                  _c("span", { staticClass: "avi-name" }, [
                    _vm._v(_vm._s(_vm.avi.name)),
                  ]),
                  _vm._v("'s window"),
                ]),
                _vm._v(" "),
                _c(
                  ...
                  {
                    staticClass:
                      "d-flex w-100 justify-content-center justify-items-center",
                  },
                  [
                    _c("star-rating", {
                      attrs: {
      ...
      _vm.loggedIn
        ? _c(
            ...
            [
              _c(
                ...
                [
                  _c("p", [
                    _vm._v("Post a comment about " + _vm._s(_vm.avi.name)),
                  ]),
                  _vm._v(" "),
                  _c(
                    "div",
                    ...
                    [
                      _c("b-form-group", {
                        attrs: { label: "Choose your opinion" },
                        scopedSlots: _vm._u(
                          [
                            {
                              key: "default",
                  ...
                  _c("b-form-textarea", {
                    attrs: {
                      placeholder:
                        "Choose positive or negative before submitting",
                    },
                    model: {
                  ...
                  _c(
                    ...
                    { staticClass: "mt-3" },
                    [
                      _c("b-button", { on: { click: _vm.comment } }, [
                        _vm._v("Send"),
                      ]),
                    ],
                    1
        ...
        : _c("div", { staticClass: "text-center" }, [
            _c("h2", { staticClass: "text-danger" }, [
              _vm._v("Log in to rate and comment"),
            ]),
          ]),
      _vm._v(" "),
      !_vm.loading
        ? _c("b-card", { staticClass: "pb-3", attrs: { header: "Comments" } }, [
            _c(
              "div",
              { staticClass: "commentSort" },
              [
                _c(
                  "b-button",
                  {
                    ...
                    on: {
                      click: function ($event) {
                        return _vm.sortComments("id", "desc")
                      },
                    },
                  },
                  [_vm._v("Newest to First")]
                ),
                _vm._v(" "),
                _c(
                  "b-button",
                  {
                    ...
                    on: {
                      click: function ($event) {
                        return _vm.sortComments("id", "asc")
                      },
                    },
                  },
                  [_vm._v("In order - 1st to last")]
                ),
                _vm._v(" "),
                _c(
                  "b-button",
            ...
            _c(
              ...
              _vm._l(this.sortedComments, function (item, key) {
                return _c(
                  "div",
                  { key: key, staticClass: "commentItem mt-2" },
                  [
                    item.opinion === 1
                      ? _c(
                          "b-badge",
                    ...
                    _c(
                      "div",
                      { staticClass: "commentItem__attachments" },
                      _vm._l(item.attachments, function (attachment, key) {
                        return _c(
                          "div",
                          { key: key },
                          [
                    ...
                    _c("div", { staticClass: "commentItem__content" }, [
                      ...
                      _vm._v(" "),
                      _c("span", { staticClass: "commentItem__date" }, [
